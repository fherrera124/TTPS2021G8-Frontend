...
export class Patient implements BaseModel {
  ...
  public prepare(formData: any): Patient {
    ...
    this.health_insurance_id = formData.health_insurance_id !== null && formData.health_insurance_id !== undefined && formData.health_insurance_id !== "" ? formData.health_insurance_id : null;
